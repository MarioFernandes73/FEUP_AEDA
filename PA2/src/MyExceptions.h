...
/**
* Classe NotIntException. N&atilde;o tem par&acirc;metros.
*
* &Eacute; chamada quando encontra um n&uacute;mero que n&atilde;o &eacute; inteiro.
**/
class NotIntException{
public:
	/**
	 * @brief Constructor de uma NotIntException.
	 *
	 * Constr&oacute;i uma NotIntException sem par&acirc;metros definidos.
	 **/
	NotIntException(){}
};

/**
* Classe NoSuchItemException. N&atilde;o tem par&acirc;metros.
*
* &Eacute; chamada quando um item n&atilde;o &eacute; encontrado.
**/
class NoSuchItemException{
public:
	/**
	* @brief Constructor de uma NoSuchItemException.
	*
	* Constr&oacute;i uma NoSuchItemException sem par&acirc;metros definidos.
	**/
	NoSuchItemException(){}
};

/**
* Classe NoStockException. Tem como par&acirc;metros uma string com o nome do item.
*
* &Eacute; chamada quando um item n&atilde;o tem stock.
**/
class NoStockException{
private:
	/** Nome do item que n&atilde;o tem stock. **/
	string itemName;
public:
	/**
	* @brief M&eacute;todo que retorna o nome do item sem stock.
	*
	* @return Retorna o nome do item sem stock
	**/
	string getItemName(){return this->itemName;}

	/**
	* @brief Constructor de uma NoStockException.
	*
	* Constr&oacute;i uma NoStockException com o nome do item definido.
	**/
	NoStockException(string itemName)
	{
...
/**
* Classe NotEnoughSaldoException. N&atilde;o tem par&acirc;metros.
*
* &Eacute; chamada quando um cliente n&atilde;o tem saldo.
**/
class NotEnoughSaldoException{
public:
	/**
	* @brief Constructor de uma NotEnoughSaldoException.
	*
	* Constr&oacute;i uma NotEnoughSaldoException sem par&acirc;metros definidos.
	**/
	NotEnoughSaldoException(){}
};

/**
* Classe IllegalBuyerException. N&atilde;o tem par&acirc;metros.
*
* &Eacute; chamada quando o cliente que quer comprar um item n&atilde;o existe.
**/
class IllegalBuyerException{
public:
	/**
	* @brief Constructor de uma IllegalBuyerException.
	*
	* Constr&oacute;i uma IllegalBuyerException sem par&acirc;metros definidos.
	**/
