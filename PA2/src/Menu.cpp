...
unsigned short int menuInicial()
{
	...
	cout << TAB << "5 - Menu Loja" << endl;
	cout << TAB << "6 - Menu Encontrar" << endl;
	cout << TAB << "7 - Menu Idle" << endl;
...
void opcoesIniciais(Piscina & piscina)
{
	...
	break;
	case 5:opcoesLoja(piscina);
	break;
	case 6:opcoesEncontrar(piscina);
	break;
	case 7:opcoesIdle(piscina);
	break;
	}
}
...
{
	unsigned short int opcao = -1;
	cout << TAB_BIG << "Menu Loja";
	cout << endl << endl;
	cout << TAB << "Escolha a opcao que desejar.";
	cout << endl << endl;
	cout << TAB << "1 - Vender Item." << endl;
	cout << TAB << "2 - Adicionar um novo item." << endl;
	cout << TAB << "3 - Abastecer stock de um item." << endl;
	cout << TAB << "4 - Editar preco de um item." << endl;
	cout << TAB << "5 - Remover um item." << endl;
	cout << TAB << "6 - Fazer o Inventario." << endl;
	cout << TAB << "0 - Voltar ao menu inicial" << endl;
	cout << endl;
	cout << "Escreva aqui a sua opcao: ";

	if ((opcao = leUnsignedShortInt(0, 6))>0)
		return opcao;
	else
		return 0;
}
...
{
	unsigned short int opcao;
		while((opcao=menuEncontrar()))
		{
			switch (opcao)
			{
				case 1:
				{
					Piscina temp = piscina.findPiscinaPerto(findNomeAula());
					if(temp.getNome() == "erro")
					{
						cout << "Infelizmente nao existe nenhuma aula do genero." << endl;
					}
					else if(temp.getNome() == piscina.getNome())
					{
						cout << "Esta aula vai deccorer nesta piscina!" << endl;
					}
					else
					{
						cout << "A piscina mais perto com essa aula chama se " << temp.getNome() << " que se localiza nas coordenadas: "
								<< temp.getCoordReais().first << "," << temp.getCoordReais().second << endl;
					}
				}
					break;
				case 2:
				{
					cout << piscina.getReport(findNomeAula());
				}
				break;
				case 3:
				{
					cout << piscina.printPiscinas();
				}
				break;
			}
...
{
	unsigned short int opcao=-1;
		cout << TAB_BIG << "Menu Encontrar";
		cout << endl << endl;
		cout << TAB << "Escolha a opcao que desejar.";
		cout << endl << endl;
		cout << TAB << "1 - Encontrar piscina mais perto com uma aula." << endl;
		cout << TAB << "2 - Relatorio de piscinas em funcao da aula." << endl;
		cout << TAB << "3 - Listar todas as piscinas por distância." << endl;
		cout << TAB << "0 - Voltar ao menu inicial" << endl;
		cout << endl;
		cout << "Escreva aqui a sua opcao: ";
...
{
	unsigned short int opcao;
		while((opcao=menuIdle()))
		{
			switch (opcao)
			{
				case 1:
				{
					updateMassUts2(piscina.getIdleUts());
				}
				break;
				case 2:
				{
...
{
	unsigned short int opcao=-1;
		cout << TAB_BIG << "Menu Idle";
		cout << endl << endl;
		cout << TAB << "Escolha a opcao que desejar.";
		cout << endl << endl;
		cout << TAB << "1 - Campanha para todos os utentes inativos." << endl;
		cout << TAB << "2 - Remover todos os estados inativos." << endl;
		cout << TAB << "3 - Listar tabela de utentes inativos." << endl;
		cout << TAB << "0 - Voltar ao menu inicial" << endl;
		cout << endl;
		cout << "Escreva aqui a sua opcao: ";
...
void opcoesLoja(Piscina & piscina)
{
		...
		try
	{
		switch (opcao)
		{
			case 1:
			{
				Item item = getItemDaLoja(piscina);
				Utente * buyer = findUtente(piscina);
				piscina.venderItem(buyer, item);
			}
			break;
			case 2:
			{
				Item item = getNewItem(piscina);
				piscina.addItemToStore(item);
			}
			break;
			case 3:
			{
				Item item = getItemDaLoja(piscina);
				unsigned int quantidade = getQuantidadeAbastecer();
				piscina.abastecerItem(item, quantidade);
			}
			break;
			case 4:
			{
				Item item = getItemDaLoja(piscina);
				editarItem(piscina, item);
			}
			break;
			case 5:
			{
				Item item = getItemDaLoja(piscina);
				if(confirm())
					piscina.removerItem(item);
			}
			break;
			case 6:
			{
				cout << piscina.printInventory();
			}
			break;
		}
	}
	...
	{
		cout << "Erro! Utente nao encontrado!" << endl;
	}
	catch(NotEnoughSaldoException &e)
	{
		cout << "Desculpe, voce nao tem saldo suficiente para comprar esse item."<< endl;
	}
	catch(NoStockException &e)
	{
		cout << "Desculpe, nao possuimos " << e.getItemName() << " de momento." << endl;
	}
	catch(NoSuchItemException &e)
	{
		cout << "Desculpe, nao vendemos esse item nesta loja." << endl;
	}
	catch (IsStringNumberException &e)
	{
		cout << e.getNumber() << " nao e um numero." << endl;
