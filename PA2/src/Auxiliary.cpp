...
bool findPiscina(string & piscina, string & password, string & lastDayUsed, int & XCoord, int & YCoord, string & ficheiro_utentes, string & ficheiro_professores, string & ficheiro_horario, string & ficheiro_aulas, string & ficheiro_aulas_dadas, string & ficheiro_loja)
{
	ifstream in;
...
void appendPiscina ( string piscina, string & password, string lastDayUsed, int XCoord, int YCoord, string & ficheiro_utentes, string & ficheiro_professores, string & ficheiro_horario, string & ficheiro_aulas, string & ficheiro_aulas_dadas, string & ficheiro_loja)
{
	string X, Y;
	stringstream ss;
	...
	cout <<"Por favor escreva a coordenada X da sua nova piscina: "  ;
	getline(cin, X);
	if(stringIsEmpty(X))
		throw EmptyStringException();
	if(!isInt(X))
	...
	cout <<  "Por favor escreva a coordenada Y da sua nova piscina: " ;
	getline(cin, Y);
	if(stringIsEmpty(Y))
		throw EmptyStringException();
	if(!isInt(Y))
	...
	ficheiro_loja = piscina + "_loja.txt";
	...
	if (out.is_open())
		{
			...
			out << piscina << endl << password << endl << lastDayUsed << endl << XCoord << endl << YCoord << endl << ficheiro_utentes << endl << ficheiro_professores << endl << ficheiro_horario << endl << ficheiro_aulas << endl << ficheiro_aulas_dadas << endl << ficheiro_loja;
			out.close();
...
{
	string temp;
	cout << "Pressione Y para aceitar ou outra tecla para o contrario: ";
	getline(cin,temp);
	if (temp=="Y" || temp == "y")
	{
		return true;
