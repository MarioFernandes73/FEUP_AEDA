...
/**
* @brief Cria uma string com o nome inteiro da aula para a procurar.
*
* @return Retorna uma string com o nome inteiro da aula.
**/
string findNomeAula();

/**
* @brief M&eacute;todo que actualiza a todos os utentes de um vector.
*
* @param uts Vector com os utentes a serem actualizados.
**/
void updateMassUts(vector <Utente *> uts);

/**
* @brief M&eacute;todo que adiciona um item &agrave; loja de uma piscina.
*
* @param piscina Piscina que cont&eacute;m a loja &agrave; qual o item ser&aacute; adicionado.
* @return Retorna o item adicionado &agrave; loja.
**/
Item getNewItem(Piscina & piscina);

/**
* @brief M&eacute;todo que procura um item da loja de uma piscina.
*
* @param piscina Piscina que cont&eacute;m a loja que tem o item a procurar.
**/
Item getItemDaLoja(Piscina & piscina);

/**
* @brief M&eacute;todo que edita um item da loja de uma piscina.
*
* @param piscina Piscina que cont&eacute;m a loja &agrave; qual o item ser&aacute; editado.
* @param item Item a ser editado.
**/
void editarItem(Piscina & piscina, Item item);

/**
* @brief M&eacute;todo que pergunta ao utilizador o stock que deseja adicionar a um item.
*
* @return Retorna a quantidade exigida pelo utilizador.
**/
unsigned int getQuantidadeAbastecer();

/**
* @brief M&eacute;todo que actualiza a todos os utentes inactivos de um vector, perguntando por uma actualiza&ccedil;&atilde;o dos seus contactos.
*
* @param uts Vector com os utentes a serem actualizados.
**/
...
/**
* @brief M&eacute;todo que mostra a informa&ccedil;&atilde;o de todos os utentes.
*
* @param uts Vector com os utentes a serem mostrados.
**/
