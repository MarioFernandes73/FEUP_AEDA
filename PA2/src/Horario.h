...
public:
	...
	**/
	...
	/**
	 * @brief Operador para comparar se um hor&aacute;rio &eacute; menor que outro.
	 *
	 * @param horario hor&aacute;rio a ser comparado.
	 * @return Retorna o menor hor&aacute;rio seguido do maior.
	 **/
