...
* @param ficheiro_loja String com o nome do ficheiro da loja da piscina.
...
* @param password String com a password da piscina a criar.
...
* @param ficheiro_loja String com o nome do ficheiro da loja da piscina.
**/
void appendPiscina(const string piscina, string & password, string lastDayUsed, int XCoord, int YCoord, string & ficheiro_utentes, string & ficheiro_professores, string & ficheiro_horario, string & ficheiro_aulas, string & ficheiro_aulas_dadas, string & ficheiro_loja);
...
/**
* @brief Verifica se &eacute; um n&uacute;mero inteiro.
*
* @param number String a verificar.
* @return Retorna 'true' se a string corresponder a um n&uacute;mero inteiro, 'false' caso contr&aacute;rio.
**/
